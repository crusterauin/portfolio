            ...
            <div className="w-full h-32 sm:h-56 lg:h-96 flex flex-row">
                <div className="w-1/3 bg-white border relative">
                    <div className="w-full absolute bottom-0 p-2">
                        <h1 className="text-black text-xs sm:text-sm lg:text-lg font-regular font-['Plus Jakarta Sans']">DjasMerah</h1>
                        <h1 className="text-black text-xs sm:text-sm lg:text-lg font-thin font-['Plus Jakarta Sans']">Laravel</h1>
                    </div>
                </div>
